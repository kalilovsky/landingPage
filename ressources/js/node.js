...
class nodeThreeD {
    ...
    */
    mouvementSpherique(angle, centerPos) {
        ...
        //l'idéal ça aurait été de faire une accélération progrssive puis degressive ease in ease out 
        //à faire dans le future        
        let distanceBetween = (this.gravityCenter.distanceTo(centerPos));
        if (distanceBetween > 5 && distanceBetween <100) {
            let testangle = this.gravityCenter.angleTo(centerPos);
            let perframe = randomBetween(3, 6);
